...
const resources = {
  ...
  'IMAGE_HELD': 'HELD',
  'IMAGE_TITLE_INGAME': 'Select cards to hold or say Deal',
  'IMAGE_TITLE_GAMEOVER': 'Your last hand',
  'IMAGE_HINT_DISCARD': 'discard the first card',
  'IMAGE_HINT_HOLD': 'hold the first card',
  'IMAGE_HINT_DEAL': 'deal',
  'IMAGE_HINT_SELECT': 'Yes',
  // General
  'SINGLE_COIN': 'coin',
  'PLURAL_COIN': 'coins',
