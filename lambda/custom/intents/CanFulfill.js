...
module.exports = {
  check: function(event) {
    ...
    const universalIntents = ['HighScoreIntent', 'AMAZON.RepeatIntent', 'AMAZON.FallbackIntent',
      ...
      'AMAZON.CancelIntent', 'BetIntent', 'BetMaxIntent', 'DealIntent', 'SuggestIntent',
      'AMAZON.NextIntent', 'RulesIntent', 'SelectIntent', 'ToggleIntent', 'HoldIntent',
      'HoldAllIntent', 'DiscardIntent', 'DicardAllIntent'];
